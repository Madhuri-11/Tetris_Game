...
var bloocks = randomItem;
var blocksPerTetromino = 4;
var nbBlockTypes = 4; //  possible tetrominoes
var blockSize = 32; // px
...
Game.update = function(){
    ...
    if (currentMovementTimer > movementLag) { // Prevent too rapid firing
        ...
        else if (rotates && rotates.clockwise.isDown)
        {
        ...
        else if (rotates && rotates.counterClockwise.isDown)
        {
